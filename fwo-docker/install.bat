...
REM   4. Restores BACKUP_v17_complete.sql (the gold standard preservation snapshot)
...
set BACKUP_FILE=%~dp0database\BACKUP_v17_complete.sql
...
if not exist "%BACKUP_FILE%" (
    echo.
    echo ERROR: BACKUP_v17_complete.sql not found at:
    echo   %BACKUP_FILE%
    echo.
...
REM ----- 5. Restore BACKUP_v17_complete.sql -----
