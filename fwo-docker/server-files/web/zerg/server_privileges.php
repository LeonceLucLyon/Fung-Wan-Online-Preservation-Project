<?php
/* $Id: server_privileges.php,v 2.42.2.1 2005/04/10 12:29:48 lem9 Exp $ */
            ...
            */
            ...
            foreach ($array_initials as $tmp_initial => $initial_was_found) {
                ...
                if ($initial_was_found) {
                    echo '<td><a href="' . htmlspecialchars($PHP_SELF) . '?' . $url_query . '&amp;initial=' . urlencode($tmp_initial) . '" style="font-size:' . $font_bigger . '">' . $tmp_initial . '</a></td>' . "\n";
                } else {
                    echo '<td style="font-size:' . $font_bigger . '">' . $tmp_initial . '</td>';
                }
            }
            echo '<td><a href="' . htmlspecialchars($PHP_SELF) . '?' . $url_query . '&amp;showall=1" style="font-size:' . $font_bigger . '">[' . $strShowAll . ']</a></td>' . "\n";
            echo '</tr></table>';
